...
class StratifiedReplayMemory():
    ...
    def sample(
        ...
        needed_bucket_size = len(self._new_bucket) if self.first_turn else self._locked_new_bucket_size

        new_count = min(network_optimization_period, (needed_bucket_size - self._new_index))
