...
class DND:
    ...
    def commit(self):
        ...
        pending_keys = torch.stack(self._pending_keys)
        ...
        if self.memory_size < self.max_memory:
            ...
            print("keys[append_indices]", self.keys[append_indices].shape)
            print("pending_keys[:append_count]", pending_keys[:append_count].shape)
